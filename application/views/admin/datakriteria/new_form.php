		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
                ...
                <div class="input-group-prepend">
                  <label class="input-group-text" for="JENIS_DINDING">Luas Lantai</label>
                </div>
              <select class="custom-select <?php echo form_error('JENIS_DINDING') ? 'is-invalid':'' ?>" name="JENIS_DINDING"> 
                  ...
                  <option value="2">Luas lantai 8m2 – 14m2</option>
                  <option value="1">Luas lantai  > 14m2</option>
                </select>
              </div>
			...
			<div class="input-group mb-3">
              ...
              <select class="custom-select <?php echo form_error('MAKAN_SEHARI') ? 'is-invalid':'' ?>" name="MAKAN_SEHARI"> 
                  ...
                  <option value="1">Lebih Dari 3x Sehari</option>
                </select>
              </div>
